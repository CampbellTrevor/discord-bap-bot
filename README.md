...
- Switch between **Cassette** (orange hardware and cream tracklist) and **Winamp** (silver player and green display). The browser remembers your choice; switching never changes playback or signs you out.
